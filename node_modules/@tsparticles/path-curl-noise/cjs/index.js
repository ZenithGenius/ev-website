...
async function loadCurlNoisePath(engine, refresh = true) {
    const { CurlNoiseGenerator } = await Promise.resolve().then(() => __importStar(require("./CurlNoiseGenerator.js")));
    await engine.addPathGenerator(exports.curlNoisePathName, new CurlNoiseGenerator(), refresh);
}
