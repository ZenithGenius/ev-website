...
(function (factory) {
    ...
    class SpiralDrawer {
        async draw(data) {
            const { drawSpiral } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./Utils.js"))) : new Promise((resolve_1, reject_1) => { require(["./Utils.js"], resolve_1, reject_1); }).then(__importStar));
            drawSpiral(data);
        }
