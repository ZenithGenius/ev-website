...
async function loadPolygonPath(engine, refresh = true) {
    const { PolygonPathGenerator } = await Promise.resolve().then(() => __importStar(require("./PolygonPathGenerator.js")));
    await engine.addPathGenerator(exports.polygonPathName, new PolygonPathGenerator(), refresh);
}
