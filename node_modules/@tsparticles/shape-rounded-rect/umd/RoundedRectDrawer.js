    ...
    class RoundedRectDrawer {
        async draw(data) {
            ...
            if ("roundRect" in context) {
                ...
                const { drawRoundedRect } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./Utils.js"))) : new Promise((resolve_1, reject_1) => { require(["./Utils.js"], resolve_1, reject_1); }).then(__importStar));
